...
> For the full `2.14.1 -> 3.0.1` upgrade path (all breaking changes, package/tooling changes, and known regressions), see [migration-v3.md](migration-v3.md).
...
If you are specifically on `3.0.1` and see analyzer load warnings (for example AD0001) with older SDK/Visual Studio toolchains, see the known-regressions section in [migration-v3.md](migration-v3.md) and update your SDK/tooling.
