...
`HumanizeToSymbols` call through an application-wide policy. The strategy
receives the requested precision, empty-unit behavior, culture, unit range,
separator, word mode, and symbol mode.
