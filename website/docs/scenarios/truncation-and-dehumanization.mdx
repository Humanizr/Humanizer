...
The verified source runs against `3.0.10` and current. Truncator strategies exist across the documented corpus, but overload order and Unicode behavior vary; consult the selected-version API before editing an old call.
