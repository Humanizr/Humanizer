...
The verified survey runs on `3.0.10` and current. Enum generic constraints and metadata configuration change in Humanizer 3. Locale punctuation is versioned data even when the source call compiles unchanged.
