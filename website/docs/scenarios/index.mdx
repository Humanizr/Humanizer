...
Every substantive scenario imports source compiled against Humanizer `3.0.10` and the current checkout. This smallest example demonstrates the shared rule: set culture explicitly, call Humanizer at the presentation boundary, and assert the result.
