...
Core inflection is available across the documented release set. Individual vocabulary rules and overloads have changed, and early Humanizer `3.0.x` temporarily lacked quantity overloads restored by `3.0.8`. The verified source targets `3.0.10` and current.
...
- [Selected-version inflection and quantity APIs](../api/index.md)
