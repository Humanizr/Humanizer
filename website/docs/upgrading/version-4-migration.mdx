...
| `bs` feminine ordinal words | English fallback `second` | Bosnian `druga` | Check several genders and compound values. [Coverage](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/Localisation/LocaleCoverageData.cs#L1458-L1470) |
| `hr`, `sl`, `sr`, and `sr-Latn` feminine ordinal words | numeric fallback such as `1` | authored word such as `prva` | Check several genders and compound values. [Coverage](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/Localisation/LocaleCoverageData.cs#L1471-L1515) |
