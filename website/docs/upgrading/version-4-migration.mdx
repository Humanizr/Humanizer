...
| **Before** | Ampersands are dropped, some separators survive identifier conversion, and identifier casing follows the ambient culture. |
| **After** | Ampersands are tokens, spaces and dots are identifier boundaries, and identifier casing is culture-invariant. |
...
| **Evidence** | Candidate tests for [ampersands](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/StringHumanizeTests.cs#L130-L151) and [identifier transformations](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/InflectorTests.cs#L186-L336). |
...
| **Evidence** | Candidate [large-unit tests](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/Bytes/LargeDataUnitTests.cs#L32-L66) and [byte-rate value tests](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/Bytes/ByteRateTests.cs#L57-L92). |
...
| `bs`, `hr`, `sl`, `sr`, and `sr-Latn` feminine ordinal words | numeric fallback such as `1` | authored word such as `prva` | Check several genders and compound values. [Coverage](https://github.com/Humanizr/Humanizer/blob/146d74c025b80fa615bd8660f3c4c4949f61ac56/tests/Humanizer.Tests/Localisation/LocaleCoverageData.cs#L1458-L1515) |
