---
title: 'Humanizer.DateToOrdinalWordsExtensions'
sidebar_label: 'Humanizer.DateToOrdinalWordsExtensions'
description: 'API reference for Humanizer.DateToOrdinalWordsExtensions.'
---
...
- *Methods*
  - **[ToOrdinalWords\(this DateOnly\)](Humanizer.DateToOrdinalWordsExtensions.md#Humanizer.DateToOrdinalWordsExtensions.ToOrdinalWords(thisSystem.DateOnly) 'Humanizer\.DateToOrdinalWordsExtensions\.ToOrdinalWords\(this System\.DateOnly\)')**
  - **[ToOrdinalWords\(this DateOnly, GrammaticalCase\)](Humanizer.DateToOrdinalWordsExtensions.md#Humanizer.DateToOrdinalWordsExtensions.ToOrdinalWords(thisSystem.DateOnly,Humanizer.GrammaticalCase) 'Humanizer\.DateToOrdinalWordsExtensions\.ToOrdinalWords\(this System\.DateOnly, Humanizer\.GrammaticalCase\)')**
  - **[ToOrdinalWords\(this DateTime\)](Humanizer.DateToOrdinalWordsExtensions.md#Humanizer.DateToOrdinalWordsExtensions.ToOrdinalWords(thisSystem.DateTime) 'Humanizer\.DateToOrdinalWordsExtensions\.ToOrdinalWords\(this System\.DateTime\)')**
  - **[ToOrdinalWords\(this DateTime, GrammaticalCase\)](Humanizer.DateToOrdinalWordsExtensions.md#Humanizer.DateToOrdinalWordsExtensions.ToOrdinalWords(thisSystem.DateTime,Humanizer.GrammaticalCase) 'Humanizer\.DateToOrdinalWordsExtensions\.ToOrdinalWords\(this System\.DateTime, Humanizer\.GrammaticalCase\)')**
### Methods
