---
title: 'Humanizer.ICollectionFormatter'
sidebar_label: 'Humanizer.ICollectionFormatter'
description: 'API reference for Humanizer.ICollectionFormatter.'
---
...
- *Methods*
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>\)')**
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;, string\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_,string) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>, string\)')**
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;, Func&lt;T,object&gt;\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_,System.Func_T,object_) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>, System\.Func\<T,object\>\)')**
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;, Func&lt;T,object&gt;, string\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_,System.Func_T,object_,string) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>, System\.Func\<T,object\>, string\)')**
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;, Func&lt;T,string&gt;\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_,System.Func_T,string_) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>, System\.Func\<T,string\>\)')**
  - **[Humanize&lt;T&gt;\(IEnumerable&lt;T&gt;, Func&lt;T,string&gt;, string\)](Humanizer.ICollectionFormatter.md#Humanizer.ICollectionFormatter.Humanize_T_(System.Collections.Generic.IEnumerable_T_,System.Func_T,string_,string) 'Humanizer\.ICollectionFormatter\.Humanize\<T\>\(System\.Collections\.Generic\.IEnumerable\<T\>, System\.Func\<T,string\>, string\)')**
### Methods
