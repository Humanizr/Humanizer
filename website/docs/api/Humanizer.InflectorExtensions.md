---
title: 'Humanizer.InflectorExtensions'
sidebar_label: 'Humanizer.InflectorExtensions'
description: 'API reference for Humanizer.InflectorExtensions.'
---
...
- *Methods*
  - **[Camelize\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Camelize(thisstring) 'Humanizer\.InflectorExtensions\.Camelize\(this string\)')**
  - **[Dasherize\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Dasherize(thisstring) 'Humanizer\.InflectorExtensions\.Dasherize\(this string\)')**
  - **[Hyphenate\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Hyphenate(thisstring) 'Humanizer\.InflectorExtensions\.Hyphenate\(this string\)')**
  - **[Kebaberize\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Kebaberize(thisstring) 'Humanizer\.InflectorExtensions\.Kebaberize\(this string\)')**
  - **[Pascalize\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Pascalize(thisstring) 'Humanizer\.InflectorExtensions\.Pascalize\(this string\)')**
  - **[Pascalize\(this string, bool\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Pascalize(thisstring,bool) 'Humanizer\.InflectorExtensions\.Pascalize\(this string, bool\)')**
  - **[Pluralize\(this string, bool\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Pluralize(thisstring,bool) 'Humanizer\.InflectorExtensions\.Pluralize\(this string, bool\)')**
  - **[Singularize\(this string, bool, bool\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Singularize(thisstring,bool,bool) 'Humanizer\.InflectorExtensions\.Singularize\(this string, bool, bool\)')**
  - **[Titleize\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Titleize(thisstring) 'Humanizer\.InflectorExtensions\.Titleize\(this string\)')**
  - **[ToCamelCase\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.ToCamelCase(thisstring) 'Humanizer\.InflectorExtensions\.ToCamelCase\(this string\)')**
  - **[ToPossessive\(this string, bool, bool\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.ToPossessive(thisstring,bool,bool) 'Humanizer\.InflectorExtensions\.ToPossessive\(this string, bool, bool\)')**
  - **[Underscore\(this string\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Underscore(thisstring) 'Humanizer\.InflectorExtensions\.Underscore\(this string\)')**
  - **[Underscore\(this string, bool\)](Humanizer.InflectorExtensions.md#Humanizer.InflectorExtensions.Underscore(thisstring,bool) 'Humanizer\.InflectorExtensions\.Underscore\(this string, bool\)')**
### Methods
