...
<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisdouble,bool,bool,System.Nullable_int_)'></a>
...
<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisdouble,bool,bool,System.Nullable_int_).input'></a>
...
<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisdouble,bool,bool,System.Nullable_int_).hasSpace'></a>

`hasSpace` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

True will split the number and the symbol with a whitespace\.

<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisdouble,bool,bool,System.Nullable_int_).useSymbol'></a>

`useSymbol` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

True will use symbol instead of name

<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisdouble,bool,bool,System.Nullable_int_).decimals'></a>
...
<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisint,bool,bool,System.Nullable_int_)'></a>
...
<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisint,bool,bool,System.Nullable_int_).input'></a>

`input` [System\.Int32](https://learn.microsoft.com/en-us/dotnet/api/system.int32 'System\.Int32')

Number to convert to a Metric representation\.

<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisint,bool,bool,System.Nullable_int_).hasSpace'></a>

`hasSpace` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

True will split the number and the symbol with a whitespace\.

<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisint,bool,bool,System.Nullable_int_).useSymbol'></a>

`useSymbol` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

True will use symbol instead of name

<a name='Humanizer.MetricNumeralExtensions.ToMetric(thisint,bool,bool,System.Nullable_int_).decimals'></a>
