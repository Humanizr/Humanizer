...
<a name='Humanizer.Localisation.DateToOrdinalWords.IDateToOrdinalWordConverter.Convert(System.DateTime)'></a>
...
<a name='Humanizer.Localisation.DateToOrdinalWords.IDateToOrdinalWordConverter.Convert(System.DateTime).date'></a>
...
<a name='Humanizer.Localisation.DateToOrdinalWords.IDateToOrdinalWordConverter.Convert(System.DateTime,Humanizer.GrammaticalCase)'></a>
...
<a name='Humanizer.Localisation.DateToOrdinalWords.IDateToOrdinalWordConverter.Convert(System.DateTime,Humanizer.GrammaticalCase).date'></a>

`date` [System\.DateTime](https://learn.microsoft.com/en-us/dotnet/api/system.datetime 'System\.DateTime')

<a name='Humanizer.Localisation.DateToOrdinalWords.IDateToOrdinalWordConverter.Convert(System.DateTime,Humanizer.GrammaticalCase).grammaticalCase'></a>
