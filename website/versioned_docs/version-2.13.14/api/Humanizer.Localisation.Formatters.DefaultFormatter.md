...
<a name='Humanizer.Localisation.Formatters.DefaultFormatter.TimeUnitHumanize(Humanizer.Localisation.TimeUnit)'></a>
...
<a name='Humanizer.Localisation.Formatters.DefaultFormatter.TimeUnitHumanize(Humanizer.Localisation.TimeUnit).timeUnit'></a>

`timeUnit` [TimeUnit](Humanizer.Localisation.TimeUnit.md 'Humanizer\.Localisation\.TimeUnit')

Time unit

Implements [TimeUnitHumanize\(TimeUnit\)](Humanizer.Localisation.Formatters.IFormatter.md#Humanizer.Localisation.Formatters.IFormatter.TimeUnitHumanize(Humanizer.Localisation.TimeUnit) 'Humanizer\.Localisation\.Formatters\.IFormatter\.TimeUnitHumanize\(Humanizer\.Localisation\.TimeUnit\)')
