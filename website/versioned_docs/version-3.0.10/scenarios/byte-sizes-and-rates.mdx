...
Core `ByteSize` creation and formatting span the documented corpus.
Culture-aware `ByteRate.Humanize` appears in `2.13.14`; earlier snapshots need a
reduced example or exclusion. The verified source runs against the selected
package.
