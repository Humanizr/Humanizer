...
Transform a time unit into a symbol; e\.g\. [Humanizer\.TimeUnit\.Year](https://learn.microsoft.com/en-us/dotnet/api/humanizer.timeunit.year 'Humanizer\.TimeUnit\.Year') =\> "a"
