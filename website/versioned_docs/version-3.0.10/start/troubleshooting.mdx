...
| --- | --- | --- |
| API page or method is missing | Package version, selected docs version, TFM | Keep the site on `3.0.10`; check the page’s version notes and selected API root. |
...
| Search or a copied URL opens another API version | Current selector and URL | Re-select `3.0.10`, then navigate from its API root. Narrative and API routes are versioned together. |
