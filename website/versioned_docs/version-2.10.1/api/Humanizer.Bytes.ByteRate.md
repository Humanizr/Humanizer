...
<a name='Humanizer.Bytes.ByteRate.Humanize(string,Humanizer.Localisation.TimeUnit)'></a>
...
<a name='Humanizer.Bytes.ByteRate.Humanize(string,Humanizer.Localisation.TimeUnit).format'></a>
...
<a name='Humanizer.Bytes.ByteRate.Humanize(string,Humanizer.Localisation.TimeUnit).timeUnit'></a>
