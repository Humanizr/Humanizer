namespace Humanizer
{
    class CatalanNumberToWordsConverter : GenderedNumberToWordsConverter
    {
        ...
        private string GetUnit(int number, GrammaticalGender gender)
        ...
        public override string ConvertToOrdinal(int number, GrammaticalGender gender, WordForm wordForm)
        {
            ...
            {
                if (number == 1) return gender == GrammaticalGender.Feminine ? "1a" : "1r";
                if (number == 2) return gender == GrammaticalGender.Feminine ? "2a" : "2n";
                if (number == 3) return gender == GrammaticalGender.Feminine ? "3a" : "3r";
