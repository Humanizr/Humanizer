...
{
    internal class PortuguesePortugueseNumberToWordsConverter : GenderedNumberToWordsConverter
    {
        private static readonly string[] PortugueseUnitsMap = { "zero", "um", "dois", "três", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez", "onze", "doze", "treze", "quatorze", "quinze", "dezasseis", "dezessete", "dezoito", "dezenove" };
        ...
        private static readonly string[] PortugueseOrdinalTensMap = { "zero", "décimo", "vigésimo", "trigésimo", "quadragésimo", "quinquagésimo", "sexagésimo", "septuagésimo", "octagésimo", "nonagésimo" };
        private static readonly string[] PortugueseOrdinalHundredsMap = { "zero", "centésimo", "duocentésimo", "tricentésimo", "quadringentésimo", "quingentésimo", "sexcentésimo", "septingentésimo", "octingentésimo", "noningentésimo" };
        ...
        public override string Convert(int number, GrammaticalGender gender)
        {
            ...
            if ((number / 1000000000) > 0)
            {
                ...
                parts.Add(number / 1000000000 > 2
                    ? string.Format("{0} biliões", Convert(number / 1000000000, GrammaticalGender.Masculine))
                    : string.Format("{0} bilião", Convert(number / 1000000000, GrammaticalGender.Masculine)));
