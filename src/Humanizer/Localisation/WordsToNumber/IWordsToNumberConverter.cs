...
{
    /// <summary>
    /// Attempts to convert <paramref name="words"/> into an integer value.
    /// </summary>
    /// <param name="words">The localized number phrase to convert.</param>
    /// <param name="parsedValue">When this method returns, contains the parsed integer value. The value is meaningful only when the method returns <c>true</c>.</param>
    ...
    /// <summary>
    /// Attempts to convert <paramref name="words"/> into an integer value and reports the first
    ...
    /// <summary>
    /// Converts <paramref name="words"/> into an integer value.
    /// </summary>
    /// <param name="words">The localized number phrase to convert.</param>
