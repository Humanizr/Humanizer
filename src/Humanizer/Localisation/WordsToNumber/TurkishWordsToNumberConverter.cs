...
internal class TurkishWordsToNumberConverter : GenderlessWordsToNumberConverter
{
    ...
    public override bool TryConvert(string words, out int parsedValue, out string? unrecognizedWord)
    {
        ...
        if (normalized.StartsWith("eksi ", StringComparison.Ordinal))
        {
            negative = true;
            normalized = normalized["eksi ".Length..];
        }
