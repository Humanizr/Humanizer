class PolishResources : IResources
{
    public string Culture => "pl";
    public static PolishResources Instance => new();
    public string DateSingleSecondAgo => "przed sekundą";
    public string DateMultipleSecondsAgo => "przed {0} sekundami";
    public string DateSingleMinuteAgo => "przed minutą";
    public string DateMultipleMinutesAgo => "przed {0} minutami";
    public string DateSingleHourAgo => "przed godziną";
    public string DateMultipleHoursAgo => "przed {0} godzinami";
    public string DateSingleDayAgo => "wczoraj";
    public string DateMultipleDaysAgo => "przed {0} dniami";
    public string DateSingleMonthAgo => "przed miesiącem";
    public string DateMultipleMonthsAgo => "przed {0} miesiącami";
    public string DateSingleYearAgo => "przed rokiem";
    public string DateMultipleYearsAgo => "przed {0} laty";
    public string TimeSpanMultipleDays => "{0} dni";
    public string TimeSpanMultipleHours => "{0} godzin";
    ...
    public string TimeSpanSingleDay => "1 dzień";
    public string TimeSpanSingleHour => "1 godzina";
    ...
    public string TimeSpanZero => "brak czasu";
    public string TimeSpanMultipleWeeks => "{0} tygodni";
    public string TimeSpanSingleWeek => "1 tydzień";
    public string DateMultipleDaysFromNow => "za {0} dni";
    public string DateMultipleHoursFromNow => "za {0} godzin";
    public string DateMultipleMinutesFromNow => "za {0} minut";
    public string DateMultipleMonthsFromNow => "za {0} miesięcy";
    public string DateMultipleSecondsFromNow => "za {0} sekund";
    public string DateMultipleYearsFromNow => "za {0} lat";
    public string DateNow => "teraz";
    public string DateSingleDayFromNow => "jutro";
    public string DateSingleHourFromNow => "za godzinę";
    public string DateSingleMinuteFromNow => "za minutę";
    public string DateSingleMonthFromNow => "za miesiąc";
    public string DateSingleSecondFromNow => "za sekundę";
    public string DateSingleYearFromNow => "za rok";
    public string DateMultipleDaysAgoPaucal => "przed {0} dniami";
    public string DateMultipleDaysFromNowPaucal => "za {0} dni";
    public string DateMultipleHoursAgoPaucal => "przed {0} godzinami";
    public string DateMultipleHoursFromNowPaucal => "za {0} godziny";
    public string DateMultipleMinutesAgoPaucal => "przed {0} minutami";
    public string DateMultipleMinutesFromNowPaucal => "za {0} minuty";
    public string DateMultipleMonthsAgoPaucal => "przed {0} miesiącami";
    public string DateMultipleMonthsFromNowPaucal => "za {0} miesiące";
    public string DateMultipleSecondsAgoPaucal => "przed {0} sekundami";
    public string DateMultipleSecondsFromNowPaucal => "za {0} sekundy";
    public string DateMultipleYearsAgoPaucal => "przed {0} laty";
    public string DateMultipleYearsFromNowPaucal => "za {0} lata";
    public string TimeSpanMultipleDaysPaucal => "{0} dni";
    public string TimeSpanMultipleHoursPaucal => "{0} godziny";
    ...
    public string TimeSpanMultipleWeeksPaucal => "{0} tygodnie";
    public string TimeSpanMultipleMonths => "{0} miesięcy";
    public string TimeSpanMultipleMonthsPaucal => "{0} miesiące";
    public string TimeSpanMultipleYears => "{0} lat";
    public string TimeSpanMultipleYearsPaucal => "{0} lata";
    public string TimeSpanSingleMonth => "1 miesiąc";
