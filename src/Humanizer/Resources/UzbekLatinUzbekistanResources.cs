class UzbekLatinUzbekistanResources : IResources
{
    public string Culture => "uz-Latn-UZ";
    public static UzbekLatinUzbekistanResources Instance => new();
    public string DateMultipleDaysAgo => "{0} kun avval";
    public string DateMultipleDaysFromNow => "{0} kundan so`ng";
    public string DateMultipleHoursAgo => "{0} soat avval";
    public string DateMultipleHoursFromNow => "{0} soatdan so`ng";
    public string DateMultipleMinutesAgo => "{0} minut avval";
    public string DateMultipleMinutesFromNow => "{0} minutdan so`ng";
    public string DateMultipleMonthsAgo => "{0} oy avval";
    public string DateMultipleMonthsFromNow => "{0} oydan so`ng";
    public string DateMultipleSecondsAgo => "{0} sekund avval";
    public string DateMultipleSecondsFromNow => "{0} sekunddan so`ng";
    public string DateMultipleYearsAgo => "{0} yil avval";
    public string DateMultipleYearsFromNow => "{0} yildan so`ng";
    public string DateNow => "hozir";
    public string DateSingleDayAgo => "kecha";
    public string DateSingleDayFromNow => "ertaga";
    public string DateSingleHourAgo => "bir soat avval";
    public string DateSingleHourFromNow => "bir soatdan so`ng";
    public string DateSingleMinuteAgo => "bir daqiqa avval";
    public string DateSingleMinuteFromNow => "bir daqiqadan so`ng";
    public string DateSingleMonthAgo => "bir oy avval";
    public string DateSingleMonthFromNow => "bir oydan so`ng";
    public string DateSingleSecondAgo => "bir soniya avval";
    public string DateSingleSecondFromNow => "bir soniyadan so`ng";
    public string DateSingleYearAgo => "bir yil avval";
    public string DateSingleYearFromNow => "bir yildan so`ng";
    public string TimeSpanMultipleDays => "{0} kun";
    public string TimeSpanMultipleHours => "{0} soat";
    public string TimeSpanMultipleMilliseconds => "{0} millisekund";
    public string TimeSpanMultipleMinutes => "{0} minut";
    public string TimeSpanMultipleMonths => "{0} oy";
    public string TimeSpanMultipleSeconds => "{0} sekund";
    public string TimeSpanMultipleWeeks => "{0} hafta";
    public string TimeSpanMultipleYears => "{0} yil";
    public string TimeSpanSingleDay => "1 kun";
    public string TimeSpanSingleHour => "1 soat";
    public string TimeSpanSingleMillisecond => "1 millisekund";
    public string TimeSpanSingleMinute => "1 minut";
    public string TimeSpanSingleMonth => "1 oy";
    public string TimeSpanSingleSecond => "1 sekund";
    public string TimeSpanSingleWeek => "1 hafta";
    public string TimeSpanSingleYear => "1 yil";
    public string TimeSpanZero => "vaqt yo`q";
