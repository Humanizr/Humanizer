class AzerbaijaniResources : IResources
{
    public string Culture => "az";
    public static AzerbaijaniResources Instance => new();
    public string DateSingleSecondAgo => "bir saniyə əvvəl";
    public string DateMultipleSecondsAgo => "{0} saniyə əvvəl";
    public string DateSingleMinuteAgo => "bir dəqiqə əvvəl";
    public string DateMultipleMinutesAgo => "{0} dəqiqə əvvəl";
    public string DateSingleHourAgo => "bir saat əvvəl";
    public string DateMultipleHoursAgo => "{0} saat əvvəl";
    public string DateSingleDayAgo => "dünən";
    public string DateMultipleDaysAgo => "{0} gün əvvəl";
    public string DateSingleMonthAgo => "bir ay əvvəl";
    public string DateMultipleMonthsAgo => "{0} ay əvvəl";
    public string DateSingleYearAgo => "bir il əvvəl";
    public string DateMultipleYearsAgo => "{0} il əvvəl";
    public string TimeSpanMultipleDays => "{0} gün";
    public string TimeSpanMultipleHours => "{0} saat";
    public string TimeSpanMultipleMilliseconds => "{0} millisaniyə";
    public string TimeSpanMultipleMinutes => "{0} dəqiqə";
    public string TimeSpanMultipleSeconds => "{0} saniyə";
    public string TimeSpanSingleDay => "1 gün";
    public string TimeSpanSingleHour => "1 saat";
    public string TimeSpanSingleMillisecond => "1 millisaniyə";
    public string TimeSpanSingleMinute => "1 dəqiqə";
    public string TimeSpanSingleSecond => "1 saniyə";
    public string TimeSpanZero => "zaman fərqi yoxdur";
    public string TimeSpanMultipleWeeks => "{0} həftə";
    public string TimeSpanSingleWeek => "1 həftə";
    public string DateMultipleDaysFromNow => "{0} gün sonra";
    public string DateMultipleHoursFromNow => "{0} saat sonra";
    public string DateMultipleMinutesFromNow => "{0} dəqiqə sonra";
    public string DateMultipleMonthsFromNow => "{0} ay sonra";
    public string DateMultipleSecondsFromNow => "{0} saniyə sonra";
    public string DateMultipleYearsFromNow => "{0} il sonra";
    public string DateNow => "indi";
    public string DateSingleDayFromNow => "sabah";
    public string DateSingleHourFromNow => "bir saat sonra";
    public string DateSingleMinuteFromNow => "bir dəqiqə sonra";
    public string DateSingleMonthFromNow => "bir ay sonra";
    public string DateSingleSecondFromNow => "bir saniyə sonra";
    public string DateSingleYearFromNow => "bir il sonra";
    public string TimeSpanMultipleMonths => "{0} ay";
    public string TimeSpanMultipleYears => "{0} il";
    public string TimeSpanSingleMonth => "1 ay";
    public string TimeSpanSingleYear => "1 il";
