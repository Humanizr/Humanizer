class ArmenianResources : IResources
{
    public string Culture => "hy";
    public static ArmenianResources Instance => new();
    public string DateSingleSecondAgo => "մեկ վայրկյան առաջ";
    public string DateSingleMinuteAgo => "մեկ րոպե առաջ";
    public string DateSingleHourAgo => "մեկ ժամ առաջ";
    public string DateSingleDayAgo => "երեկ";
    public string DateSingleMonthAgo => "մեկ ամիս առաջ";
    public string DateSingleYearAgo => "մեկ տարի առաջ";
    public string DateMultipleHoursAgo => "{0} ժամ առաջ";
    public string DateMultipleMinutesAgo => "{0} րոպե առաջ";
    public string DateMultipleMonthsAgo => "{0} ամիս առաջ";
    public string DateMultipleSecondsAgo => "{0} վայրկյան առաջ";
    public string DateMultipleYearsAgo => "{0} տարի առաջ";
    public string DateMultipleDaysAgo => "{0} օր առաջ";
    public string DateNow => "հիմա";
    public string TimeSpanMultipleDays => "{0} օր";
    public string TimeSpanMultipleHours => "{0} ժամ";
    public string TimeSpanMultipleMilliseconds => "{0} միլիվայրկյան";
    public string TimeSpanMultipleMinutes => "{0} րոպե";
    public string TimeSpanMultipleSeconds => "{0} վայրկյան";
    public string TimeSpanMultipleWeeks => "{0} շաբաթ";
    public string TimeSpanSingleDay => "մեկ օր";
    public string TimeSpanSingleHour => "մեկ ժամ";
    public string TimeSpanSingleMillisecond => "մեկ միլիվայրկյան";
    public string TimeSpanSingleMinute => "մեկ րոպե";
    public string TimeSpanSingleSecond => "մեկ վայրկյան";
    public string TimeSpanSingleWeek => "մեկ շաբաթ";
    public string TimeSpanZero => "ժամանակը բացակայում է";
    public string DateMultipleDaysFromNow => "{0} օրից";
    public string DateMultipleHoursFromNow => "{0} ժամից";
    public string DateMultipleMinutesFromNow => "{0} րոպեից";
    public string DateMultipleMonthsFromNow => "{0} ամսից";
    public string DateMultipleSecondsFromNow => "{0} վայրկյանից";
    public string DateMultipleYearsFromNow => "{0} տարուց";
    public string DateSingleDayFromNow => "վաղը";
    public string DateSingleHourFromNow => "մեկ ժամից";
    public string DateSingleMinuteFromNow => "մեկ րոպեից";
    public string DateSingleMonthFromNow => "մեկ ամսից";
    public string DateSingleSecondFromNow => "մեկ վայրկյանից";
    public string DateSingleYearFromNow => "մեկ տարուց";
    public string TimeSpanMultipleMonths => "{0} ամիս";
    public string TimeSpanMultipleYears => "{0} տարի";
    public string TimeSpanSingleMonth => "մեկ ամիս";
    public string TimeSpanSingleYear => "մեկ տարի";
