class ItalianResources : IResources
{
    public string Culture => "it";
    public static ItalianResources Instance => new();
    public string DateSingleSecondAgo => "un secondo fa";
    public string DateMultipleSecondsAgo => "{0} secondi fa";
    public string DateSingleMinuteAgo => "un minuto fa";
    public string DateMultipleMinutesAgo => "{0} minuti fa";
    public string DateSingleHourAgo => "un'ora fa";
    public string DateMultipleHoursAgo => "{0} ore fa";
    public string DateSingleDayAgo => "ieri";
    public string DateMultipleDaysAgo => "{0} giorni fa";
    public string DateSingleMonthAgo => "un mese fa";
    public string DateMultipleMonthsAgo => "{0} mesi fa";
    public string DateSingleYearAgo => "un anno fa";
    public string DateMultipleYearsAgo => "{0} anni fa";
    public string TimeSpanMultipleDays => "{0} giorni";
    public string TimeSpanMultipleHours => "{0} ore";
    public string TimeSpanMultipleMilliseconds => "{0} millisecondi";
    public string TimeSpanMultipleMinutes => "{0} minuti";
    public string TimeSpanMultipleSeconds => "{0} secondi";
    public string TimeSpanSingleDay => "1 giorno";
    public string TimeSpanSingleHour => "1 ora";
    public string TimeSpanSingleMillisecond => "1 millisecondo";
    public string TimeSpanSingleMinute => "1 minuto";
    public string TimeSpanSingleSecond => "1 secondo";
    public string TimeSpanZero => "0 secondi";
    public string TimeSpanMultipleWeeks => "{0} settimane";
    public string TimeSpanSingleWeek => "1 settimana";
    public string DateMultipleDaysFromNow => "tra {0} giorni";
    public string DateMultipleHoursFromNow => "tra {0} ore";
    public string DateMultipleMinutesFromNow => "tra {0} minuti";
    public string DateMultipleMonthsFromNow => "tra {0} mesi";
    public string DateMultipleSecondsFromNow => "tra {0} secondi";
    public string DateMultipleYearsFromNow => "tra {0} anni";
    public string DateNow => "adesso";
    public string DateSingleDayFromNow => "domani";
    public string DateSingleHourFromNow => "tra un'ora";
    public string DateSingleMinuteFromNow => "tra un minuto";
    public string DateSingleMonthFromNow => "tra un mese";
    public string DateSingleSecondFromNow => "tra un secondo";
    public string DateSingleYearFromNow => "tra un anno";
    public string TimeSpanMultipleMonths => "{0} mesi";
    public string TimeSpanMultipleYears => "{0} anni";
    public string TimeSpanSingleMonth => "1 mese";
    public string TimeSpanSingleYear => "1 anno";
    public string TimeSpanSingleDayWords => "un giorno";
    public string TimeSpanSingleHourWords => "una ora";
    public string TimeSpanSingleMillisecondWords => "un millisecondo";
    public string TimeSpanSingleMinuteWords => "un minuto";
    public string TimeSpanSingleMonthWords => "un mese";
    public string TimeSpanSingleSecondWords => "un secondo";
    public string TimeSpanSingleWeekWords => "una settimana";
    public string TimeSpanSingleYearWords => "un anno";
