class DutchResources : IResources
{
    public string Culture => "nl";
    public static DutchResources Instance => new();
    public string DateSingleSecondAgo => "1 seconde geleden";
    public string DateMultipleSecondsAgo => "{0} seconden geleden";
    public string DateSingleMinuteAgo => "1 minuut geleden";
    public string DateMultipleMinutesAgo => "{0} minuten geleden";
    public string DateSingleHourAgo => "1 uur geleden";
    public string DateMultipleHoursAgo => "{0} uur geleden";
    public string DateSingleDayAgo => "gisteren";
    public string DateMultipleDaysAgo => "{0} dagen geleden";
    public string DateSingleMonthAgo => "1 maand geleden";
    public string DateMultipleMonthsAgo => "{0} maanden geleden";
    public string DateSingleYearAgo => "1 jaar geleden";
    public string DateMultipleYearsAgo => "{0} jaar geleden";
    public string TimeSpanMultipleDays => "{0} dagen";
    public string TimeSpanMultipleHours => "{0} uur";
    public string TimeSpanMultipleMilliseconds => "{0} milliseconden";
    public string TimeSpanMultipleMinutes => "{0} minuten";
    public string TimeSpanMultipleSeconds => "{0} seconden";
    public string TimeSpanMultipleWeeks => "{0} weken";
    ...
    public string TimeSpanZero => "geen tijd";
    public string DateMultipleDaysFromNow => "over {0} dagen";
    public string DateMultipleHoursFromNow => "over {0} uur";
    public string DateMultipleMinutesFromNow => "over {0} minuten";
    public string DateMultipleMonthsFromNow => "over {0} maanden";
    public string DateMultipleSecondsFromNow => "over {0} seconden";
    public string DateMultipleYearsFromNow => "over {0} jaar";
    public string DateNow => "nu";
    public string DateSingleDayFromNow => "morgen";
    public string DateSingleHourFromNow => "over 1 uur";
    public string DateSingleMinuteFromNow => "over 1 minuut";
    public string DateSingleMonthFromNow => "over 1 maand";
    public string DateSingleSecondFromNow => "over 1 seconde";
    public string DateSingleYearFromNow => "over 1 jaar";
    public string TimeSpanMultipleMonths => "{0} maanden";
