class ChineseTraditionalResources : IResources
{
    public string Culture => "zh-Hant";
    public static ChineseTraditionalResources Instance => new();
    public string DateSingleSecondAgo => "1 秒鐘前";
    public string DateMultipleSecondsAgo => "{0} 秒鐘前";
    public string DateSingleMinuteAgo => "1 分鐘前";
    public string DateMultipleMinutesAgo => "{0} 分鐘前";
    public string DateSingleHourAgo => "1 小時前";
    public string DateMultipleHoursAgo => "{0} 小時前";
    public string DateSingleDayAgo => "昨天";
    public string DateMultipleDaysAgo => "{0} 天前";
    public string DateSingleMonthAgo => "1 個月前";
    public string DateMultipleMonthsAgo => "{0} 個月前";
    public string DateSingleYearAgo => "去年";
    public string DateMultipleYearsAgo => "{0} 年前";
    public string TimeSpanMultipleDays => "{0} 天";
    public string TimeSpanMultipleHours => "{0} 小時";
    ...
    public string TimeSpanSingleHour => "1 小時";
    public string TimeSpanSingleMillisecond => "1 毫秒";
    public string TimeSpanSingleMinute => "1 分";
    public string TimeSpanSingleSecond => "1 秒";
    public string TimeSpanZero => "沒有時間";
    public string TimeSpanMultipleWeeks => "{0} 周";
    public string TimeSpanSingleWeek => "1 周";
    public string DateMultipleDaysFromNow => "{0} 天後";
    public string DateMultipleHoursFromNow => "{0} 小時後";
    public string DateMultipleMinutesFromNow => "{0} 分鐘後";
    public string DateMultipleMonthsFromNow => "{0} 個月後";
    public string DateMultipleSecondsFromNow => "{0} 秒鐘後";
    public string DateMultipleYearsFromNow => "{0} 年後";
    public string DateNow => "現在";
    public string DateSingleDayFromNow => "明天";
    public string DateSingleHourFromNow => "1 小時後";
    public string DateSingleMinuteFromNow => "1 分鐘後";
    public string DateSingleMonthFromNow => "1 個月後";
    public string DateSingleSecondFromNow => "1 秒鐘後";
    public string DateSingleYearFromNow => "明年";
    public string TimeSpanMultipleMonths => "{0} 個月";
    public string TimeSpanMultipleYears => "{0} 年";
    public string TimeSpanSingleMonth => "1 個月";
