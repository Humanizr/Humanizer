class JapaneseResources : IResources
{
    public string Culture => "ja";
    public static JapaneseResources Instance => new();
    public string DateSingleSecondAgo => "1 秒前";
    public string DateMultipleSecondsAgo => "{0} 秒前";
    public string DateSingleMinuteAgo => "1 分前";
    public string DateMultipleMinutesAgo => "{0} 分前";
    public string DateSingleHourAgo => "1 時間前";
    public string DateMultipleHoursAgo => "{0} 時間前";
    public string DateSingleDayAgo => "昨日";
    public string DateMultipleDaysAgo => "{0} 日前";
    public string DateSingleMonthAgo => "先月";
    public string DateMultipleMonthsAgo => "{0} か月前";
    public string DateSingleYearAgo => "去年";
    public string DateMultipleYearsAgo => "{0} 年前";
    public string TimeSpanMultipleDays => "{0} 日";
    public string TimeSpanMultipleHours => "{0} 時間";
    public string TimeSpanMultipleMilliseconds => "{0} ミリ秒";
    public string TimeSpanMultipleMinutes => "{0} 分";
    public string TimeSpanMultipleSeconds => "{0} 秒";
    public string TimeSpanSingleDay => "1 日";
    public string TimeSpanSingleHour => "1 時間";
    public string TimeSpanSingleMillisecond => "1 ミリ秒";
    public string TimeSpanSingleMinute => "1 分";
    public string TimeSpanSingleSecond => "1 秒";
    public string TimeSpanZero => "0 秒";
    public string TimeSpanMultipleWeeks => "{0} 週間";
    public string TimeSpanSingleWeek => "1 週間";
    public string DateMultipleDaysFromNow => "{0} 日後";
    public string DateMultipleHoursFromNow => "{0} 時間後";
    public string DateMultipleMinutesFromNow => "{0} 分後";
    public string DateMultipleMonthsFromNow => "{0} か月後";
    public string DateMultipleSecondsFromNow => "{0} 秒後";
    public string DateMultipleYearsFromNow => "{0} 年後";
    public string DateNow => "今";
    public string DateSingleDayFromNow => "明日";
    public string DateSingleHourFromNow => "1 時間後";
    public string DateSingleMinuteFromNow => "1 分後";
    public string DateSingleMonthFromNow => "来月";
    public string DateSingleSecondFromNow => "1 秒後";
    public string DateSingleYearFromNow => "来年";
    public string TimeSpanMultipleMonths => "{0} ヶ月";
    public string TimeSpanMultipleYears => "{0} 年";
    public string TimeSpanSingleMonth => "1 ヶ月";
