class AfrikaansResources : IResources
{
    public string Culture => "af";
    public static AfrikaansResources Instance => new();
    public string DateSingleSecondAgo => "1 sekonde terug";
    public string DateMultipleSecondsAgo => "{0} sekondes terug";
    public string DateSingleMinuteAgo => "1 minuut terug";
    public string DateMultipleMinutesAgo => "{0} minute terug";
    public string DateSingleHourAgo => "1 uur terug";
    public string DateMultipleHoursAgo => "{0} ure gelede";
    public string DateSingleDayAgo => "gister";
    public string DateMultipleDaysAgo => "{0} dae gelede";
    public string DateSingleMonthAgo => "1 maand gelede";
    public string DateMultipleMonthsAgo => "{0} maande gelede";
    public string DateSingleYearAgo => "1 jaar gelede";
    public string DateMultipleYearsAgo => "{0} jaar gelede";
    public string TimeSpanMultipleDays => "{0} dae";
    public string TimeSpanMultipleHours => "{0} ure";
    public string TimeSpanMultipleMilliseconds => "{0} millisekondes";
    public string TimeSpanMultipleMinutes => "{0} minute";
    public string TimeSpanMultipleSeconds => "{0} sekondes";
    public string TimeSpanMultipleWeeks => "{0} weke";
    public string TimeSpanSingleDay => "1 dag";
    public string TimeSpanSingleHour => "1 uur";
    public string TimeSpanSingleMillisecond => "1 millisekond";
    public string TimeSpanSingleMinute => "1 minuut";
    public string TimeSpanSingleSecond => "1 sekond";
    public string TimeSpanSingleWeek => "1 week";
    public string TimeSpanZero => "geen tyd";
    public string DateMultipleDaysFromNow => "oor {0} dae";
    public string DateMultipleHoursFromNow => "oor {0} ure";
    public string DateMultipleMinutesFromNow => "oor {0} minute";
    public string DateMultipleMonthsFromNow => "oor {0} maande";
    public string DateMultipleSecondsFromNow => "oor {0} sekondes";
    public string DateMultipleYearsFromNow => "oor {0} jaar";
    public string DateNow => "nou";
    public string DateSingleDayFromNow => "môre";
    public string DateSingleHourFromNow => "oor 1 uur";
    public string DateSingleMinuteFromNow => "oor 1 minuut";
    public string DateSingleMonthFromNow => "oor 1 maand";
    public string DateSingleSecondFromNow => "oor 1 sekonde";
    public string DateSingleYearFromNow => "oor 1 jaar";
    public string TimeSpanSingleMonth => "1 maand";
    public string TimeSpanMultipleMonths => "{0} maande";
    public string TimeSpanMultipleYears => "{0} jaar";
    public string TimeSpanSingleYear => "1 jaar";
