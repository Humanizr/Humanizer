...
""";
    ...
    // Unicode 16.0.0 UnicodeData.txt simple lowercase mappings, compressed
    // into 674 source ranges from 1,460 mappings. Source SHA-256:
    // ff58e5823bd095166564a006e47d111130813dcf8bf234ef79fa51a870edb48f.
    const int SimpleLowercaseRangeCount = 674;
    const string SimpleLowercaseData =
        "QRlAfxZAGAZAKAACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgAC" +
        "AgACAgACAgCNAwIAAgIAAgIAAgMAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgMAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA8QEBAAICAAICAAIEAKQDAQACAgACAgCcAwEAAgIBmgMCAAID" +
        "AJ4BAQCUAwEAlgMBAAICAJoDAQCeAwIApgMBAKIDAQACBACmAwEAqgMCAKwDAQACAgACAgACAgC0AwEAAgIAtAMDAAICALQDAQAC" +
        "AgGyAwIAAgIAAgIAtgMBAAIEAAIIAAQBAAICAAQBAAICAAQBAAICAAICAAICAAICAAICAAICAAICAAICAAIDAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAIDAAQBAAICAAICAMEBAQBvAQACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgAC" +
        "AgACAgACAgACAgACAgACAgCDAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAggA1qgBAQACAgDFAgEA0KgBAwACAgCFAwEAigEB" +
        "AI4BAQACAgACAgACAgACAgACogIAAgIAAgQAAgkA6AEHAEwCAkoEAIABAgF+AxBAEghALAAQCQACAgACAgACAgACAgACAgACAgAC" +
        "AgACAgACAgACAgACAgACBgB3AwACAgANAQACAwKDAgMPoAEQH0BQAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAIKAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAICAAICAAICAB4BAAICAAICAAICAAICAAICAAICAAIDAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIDJWDvFiXAcScAwHEGAMBx0wVPoN8EUAUQmREAAgcq/y4tAv8u" +
        "wwIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgoA/XYCAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIC" +
        "AAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAAIK" +
        "Bw8QBQ8QBw8QBw8QBQ8RAA8CAA8CAA8CAA8JBw8gBw8QBw8QBw8QAQ8CAZMBAgARDAOrAQQAEQwBDwIBxwEOAQ8CAd8BAgANDAH/" +
        "AQIB+wECABGqAgC5dQQA/YIBAQCLgQEHADguDyAjAAKzBhk0yg4vYGAAAgIA7acBAQDLOwEAzacBAwACAgACAgACAgC3qAEBAPmn" +
        "AQEAvagBAQC7qAECAAIDAAIJAf2oAQIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgkAAgIAAgUAAs7yAQACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgACAgAC" +
        ...
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAAgsAAgIAAgIAh6gEAQACAgACAgACAgACAgACBQACAgDPlAUDAAICAAIE" +
        "AAICAAICAAICAAICAAICAAICAAICAAICAAICAAICAIeVBQEAnZUFAQCVlQUBAIGVBQEAh5UFAgCjlAUBANOUBQEAqZQFAQDADgEA" +
        "AgIAAgIAAgIAAgIAAgIAAgIAAgIAAgIAXwEAhZUFAQDvqAQBAAICAAICAM2VBQEAAgQAAgYAAgIAAgIAAgIAgZkFGQACrK4BGUDf" +
        "CSdQsAEjUMABCk4MDk4QBk4IAU7sDTKAAdABFUDQFh9AoKsBH0DA9QEhRA==";

    static readonly int[] SimpleLowercaseRanges = DecodeMappingRanges(
        SimpleLowercaseData,
        SimpleLowercaseRangeCount);
    // </generated-unicode-lowercase>
...
""";
    ...
    internal static int ToLowerSimple(int scalar) =>
        MapSimple(scalar, SimpleLowercaseRanges, SimpleLowercaseRangeCount);
    ...
    internal static bool HasUncertainNfcQuickCheck(int scalar)
    {
        var low = 0;
