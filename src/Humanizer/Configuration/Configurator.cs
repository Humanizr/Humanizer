...
public static class Configurator
{
    ...
    static readonly EnumDescriptionPropertyLocator DefaultEnumDescriptionPropertyLocator =
        (_, property) => property.Name == "Description";

    static EnumDescriptionPropertyLocator _enumDescriptionPropertyLocator = DefaultEnumDescriptionPropertyLocator;

    /// <summary>
    /// A predicate function for description property of attribute to use for Enum.Humanize
    /// </summary>
    public static EnumDescriptionPropertyLocator EnumDescriptionPropertyLocator
    {
...
public delegate bool EnumDescriptionPropertyLocator(Type enumType, PropertyInfo property);