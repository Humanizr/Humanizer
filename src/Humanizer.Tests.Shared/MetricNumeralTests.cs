...
namespace Humanizer.Tests
{
    ...
    public class MetricNumeralTests
    {
        ...
        [InlineData("1M",       1_000_000,    false, true,  null, 'G')]
        [InlineData("1000k",    1_000_000,    false, true,  null, 'k')]
        [InlineData("1234.56k", 1_234_560,    false, true,  null, 'k')]
        [InlineData("1m",       1E-3,         false, true,  null, null)]
        [InlineData("1000μ",    1E-3,         false, true,  null, 'μ')]
