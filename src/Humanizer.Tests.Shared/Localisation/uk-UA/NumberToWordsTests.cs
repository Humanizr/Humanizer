...
namespace Humanizer.Tests.Localisation.ukUA
{
    ...
    public class NumberToWordsTests
    {
        ...
        [InlineData(2132415, "два мільйони сто тридцять дві тисячі чотириста п'ятнадцять")]
        ...
        [InlineData(2132415, "два мільйони сто тридцять дві тисячі чотириста п'ятнадцятий")]
        ...
        [InlineData(1234567000, "один мільярд двісті тридцять чотири мільйони п'ятисотшістдесятисемитисячний")]
        [InlineData(2000000000, "двохмільярдний")]
        ...
        [InlineData(2132415, "два мільйони сто тридцять дві тисячі чотириста п'ятнадцята")]
        ...
        [InlineData(2132415, "два мільйони сто тридцять дві тисячі чотириста п'ятнадцяте")]
