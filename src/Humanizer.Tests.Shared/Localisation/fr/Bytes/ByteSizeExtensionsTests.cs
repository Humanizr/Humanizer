namespace Humanizer.Tests.Localisation.fr.Bytes
{
    ...
    public class ByteSizeExtensionsTests
    {
        ...
        [InlineData(1950, "KB", "1,95 Ko")]
        [InlineData(2123, "#.##", "2,12 Ko")]
        [InlineData(9765630, "KB", "9765,63 Ko")]
        [InlineData(9765630, "#,##0 KB", "9 766 Ko")]
        [InlineData(9765630, "#,##0.# KB", "9 765,6 Ko")]
        ...
        [InlineData(10000, "#.# KB", "1,3 Ko")]
        [InlineData(10000, "#.# KiB", "1,2 Kio")]
