...
namespace Humanizer.Tests.Localisation.ptPT
{
    public class NumberToWordsTests : AmbientCulture
    {
        ...
        [InlineData(1000000000, "um bilião")]
        ...
        [InlineData(1101111101, "um bilião cento e um milhões cento e onze mil cento e um")]
        [InlineData(1111111111, "um bilião cento e onze milhões cento e onze mil cento e onze")]
        ...
        [InlineData(1234567890, "um bilião duzentos e trinta e quatro milhões quinhentos e sessenta e sete mil oitocentos e noventa")]
        ...
        [InlineData(1111111, "um milhão cento e onze mil cento e onze")]
        [InlineData(1101111101, "um bilião cento e um milhões cento e onze mil cento e uma")]
        ...
        {
            var TestResult = number.ToWords(GrammaticalGender.Feminine);
            Assert.Equal(expected, TestResult);
        }
        ...
        [InlineData(200, "duocentésimo")]
        [InlineData(300, "tricentésimo")]
        ...
        {
            var TestResult = number.ToOrdinalWords();
            Assert.Equal(words, TestResult);
        }
        ...
        [InlineData(200, "duocentésima")]
        [InlineData(300, "tricentésima")]
        ...
        {
            var TestResult = number.ToOrdinalWords(GrammaticalGender.Feminine);
            Assert.Equal(words, TestResult);
        }
    }
}