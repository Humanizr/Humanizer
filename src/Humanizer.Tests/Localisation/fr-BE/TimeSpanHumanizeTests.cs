...
namespace Humanizer.Tests.Localisation.frBE
{
    public class TimeSpanHumanizeTests : AmbientCulture
    {
        ...
        [InlineData(62020, 2, "1 minute, 2 secondes")]
        [InlineData(62020, 3, "1 minute, 2 secondes, 20 millisecondes")]
        [InlineData(3600020, 4, "1 heure, 20 millisecondes")]
        [InlineData(3600020, 3, "1 heure, 20 millisecondes")]
        [InlineData(3600020, 2, "1 heure, 20 millisecondes")]
        ...
        [InlineData(86400000, 2, "1 jour")]
        [InlineData(86400000, 1, "1 jour")]
        [InlineData(86401000, 1, "1 jour")]
        [InlineData(86401000, 2, "1 jour, 1 seconde")]
        [InlineData(86401200, 2, "1 jour, 1 seconde")]
        [InlineData(86401200, 3, "1 jour, 1 seconde, 200 millisecondes")]
        [InlineData(1296000000, 1, "2 semaines")]
        [InlineData(1296000000, 2, "2 semaines, 1 jour")]
        [InlineData(1299600000, 2, "2 semaines, 1 jour")]
        [InlineData(1299600000, 3, "2 semaines, 1 jour, 1 heure")]
