...
public class TimeToClockNotationTests
{
    ...
    {
        var actualResult = new TimeOnly(hours, minutes).ToClockNotation(ClockNotationRounding.None, CultureInfo.CreateSpecificCulture("pt-BR"));
        Assert.Equal(expectedResult, actualResult);
    }
    ...
    {
        var actualResult = new TimeOnly(hours, minutes).ToClockNotation(ClockNotationRounding.NearestFiveMinutes, CultureInfo.CreateSpecificCulture("pt-BR"));
        Assert.Equal(expectedResult, actualResult);
    }
}
