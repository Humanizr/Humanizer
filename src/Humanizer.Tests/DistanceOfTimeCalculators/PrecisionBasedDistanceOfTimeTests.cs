...
{
    public class DateHumanizeTetsBase : IDisposable
    {
        private readonly IDistanceOfTimeInWords prevCalculator;

        public DateHumanizeTetsBase()
        {
            prevCalculator = Configurator.DistanceOfTimeInWords;
            Configurator.DistanceOfTimeInWords = new PrecisionBasedDistanceOfTime();
        }

        public void Dispose()
        {
            Configurator.DistanceOfTimeInWords = prevCalculator;
        }
    ...
    public class PrecisionBasedDistanceOfTimeTests : IDisposable
    {
        private readonly IDistanceOfTimeInWords prevCalculator;
