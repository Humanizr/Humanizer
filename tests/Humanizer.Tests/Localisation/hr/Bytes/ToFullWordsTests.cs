...
public class ToFullWordsTests
{
    ...
    public void ReturnsPaucalBytes() =>
        Assert.Equal("2 bajta", ByteSize.FromBytes(2).ToFullWords());

    [Fact]
    public void ReturnsPluralBytes() =>
        Assert.Equal("10 bajtova", ByteSize.FromBytes(10).ToFullWords());
    ...
    public void ReturnsPaucalGigabytes() =>
        Assert.Equal("2 gigabajta", ByteSize.FromGigabytes(2).ToFullWords());
