...
public class GujaratiNumberToWordsTests
{
    ...
    [InlineData(100, "એક સો")]
    [InlineData(101, "એક સો એક")]
    [InlineData(999, "નવ સો નવાણું")]
    [InlineData(1000, "એક હજાર")]
    [InlineData(99999, "નવાણું હજાર નવ સો નવાણું")]
    [InlineData(100000, "એક લાખ")]
    [InlineData(1234567, "બાર લાખ ચોત્રીસ હજાર પાંચ સો સડસઠ")]
    [InlineData(9999999, "નવાણું લાખ નવાણું હજાર નવ સો નવાણું")]
    [InlineData(10000000, "એક કરોડ")]
    [InlineData(12345678, "એક કરોડ તેવીસ લાખ પિસ્તાલીસ હજાર છ સો અઠ્યોતેર")]
    ...
    [InlineData(10000000, "એક કરોડ")]
    [InlineData(12345678, "એક કરોડ તેવીસ લાખ પિસ્તાલીસ હજાર છ સો અઠ્યોતેર")]
    [InlineData(4325010007018, "તેતાલીસ ખરબ પચ્ચીસ અબજ એક કરોડ સાત હજાર અઢાર")]
    ...
    [InlineData("એક કરોડ તેવીસ લાખ પિસ્તાલીસ હજાર છ સો અઠ્યોતેર", 12345678)]
