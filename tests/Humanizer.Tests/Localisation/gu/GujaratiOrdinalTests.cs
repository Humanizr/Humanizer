...
public class GujaratiOrdinalTests
{
    ...
    [InlineData(100, GrammaticalGender.Masculine, "એક સોમો")]
    ...
    [InlineData(100, GrammaticalGender.Feminine, "એક સોમી")]
    ...
    [InlineData(100, GrammaticalGender.Neuter, "એક સોમું")]
    ...
    [InlineData("એક સોમો", 100)]
    [InlineData("એક સોમી", 100)]
    [InlineData("એક સો એકમો", 101)]
