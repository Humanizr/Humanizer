...
function Get-ReferenceFingerprintEntries {
    $paths = @(
        ...
        "src/Humanizer.SourceGenerators/Generators/ProfileCatalogs/InflectionCatalogEmission.cs",
        "src/Humanizer.SourceGenerators/Generators/ProfileCatalogs/InflectionCatalogInput.cs",
        "src/Humanizer.SourceGenerators/Generators/ProfileCatalogs/InflectionCatalogParsing.cs",
        "src/Humanizer.SourceGenerators/Generators/ProfileCatalogs/InflectionCatalogValidation.cs",
